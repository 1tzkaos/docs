...
| `code` | Trigger | Weight | Notes |
|---|---|---|---|
| `lp_not_burnt` | LP tokens not burnt | 4000 | Returns `None` (signal sits in `missing_signals`) when the LP-burnt cron hasn't checked this mint yet — avoids a false-positive during the warm-up window. |
